...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Title
        $this->Cell(0, 15, 'Reporte de capacitaciones', 0, false, 'C', 0, '', 0, false, 'M', 'M');
    }
...
$pdf->SetAuthor('SCC');
$pdf->SetTitle('Reporte de capacitaciones');
$pdf->SetSubject('Mes');
...
// ---------------------------------------------------------
require_once('../controladores/controladorAsigModulo.php');

$idProgramacion = $_REQUEST['idProgramacion'];

$controlador = new controladorAsigModulo();

if ($conteoEntrada = mysqli_fetch_array($controlador->reporteConteoRealizadas($idProgramacion)))
    {
