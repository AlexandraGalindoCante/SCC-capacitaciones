...
$count_query   = mysqli_query($con,"SELECT  count(*) AS numrows FROM
  ...
  WHERE pr.idProgramacion='$_SESSION[idProgramacion]' AND am.idModulo ='$_SESSION[moduloEvaluacion]' AND (ev.visibilidad IS NULL OR ev.visibilidad = 1) AND empresa='CYCP'
...
// set auto page breaks
  ...
  <center><th><img src="imagenes/cycp.png"  style="height:120px; width:160px;  border="0" "></th></center>
  </tr>
  <tr style="text-align:center;">
  <th>NOMBRE</th>
  <th >CALIFICACION</th>
    ...
    <div>
      ...
      <div class="row" style="padding: 10px;">
        <table class="table table-bordered" >
          <thead>
           <tr class="success">
            <th width="200">CODIGO: GFFO-150</br> <br>FECHA: 31/08/2017 </br> <br> VERSION:0 </br></th>
