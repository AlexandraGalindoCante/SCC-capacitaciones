...
// set auto page breaks
  ...
  <th style="text-align:left;">Codigo: GFFO-01<br>Fecha: 16/12/2016<br>Version:01</th>
  <th><span style="text-align:center;"><h4>CAPACITACIONES FORMATO ASISTENCIA </h4></span></th> 
  <center><th><img src="imagenes/gf.jpg"  style="height:70px; width:110px;  border="0" "></th></center>
  </tr>
  <br>
    ...
    <div>
      ...
      <div class="row" style="padding: 10px;">
        <table class="table table-bordered" >
          <thead>
           <tr class="success">
            <th width="200">Codigo: GFFO-01<br><br> Fecha: 16/12/2016 <br><br>  Version:01 </br></th>
            <th><h5><center>ASISTENCIA <br><br><?PHP echo $_SESSION['fechaIn'];?></br></br><?PHP echo $_SESSION['hora'];?></h5></center></th>
            <th colspan="2"><img src="imagenes/gf.jpg"  style="height: 120px; width: 160px;"></th>
